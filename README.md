...
In this project, I use my learnings about deep neural networks and convolutional neural networks to clone driving behavior. I train, validate and test a model using Keras. The model outputs a steering angle to an autonomous vehicle.
...
Track 1 autnomous driving
----
[video.mp4](/video.mp4)

Track 2 autonmous driving
----
